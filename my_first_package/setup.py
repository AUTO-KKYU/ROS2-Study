...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'helloworld_publisher = my_first_package.helloworld_publisher:main',
            'helloworld_subscriber = my_first_package.helloworld_subscriber:main',
            'pyqt_turtlebot = my_first_package.pyqt_turtlebot:main',
